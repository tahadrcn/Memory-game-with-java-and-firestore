...
public class ZortActivity extends AppCompatActivity {
    ...
    CountDownTimer countDownTimerz = new CountDownTimer(45000, 1000) {
        @Override
        public void onTick(long l) {
            txt_sureyi_goster.setText("" + l / 1000);
            if (f == 18) {
                countDownTimerz.cancel();
                AlertDialog.Builder builder = new AlertDialog.Builder(ZortActivity.this);
                ...
                builder.setNegativeButton("Tamam", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Intent intent = new Intent(ZortActivity.this, KolayZorActivity.class);
        ...
        public void onFinish() {
            AlertDialog.Builder builder1 = new AlertDialog.Builder(ZortActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zort);
