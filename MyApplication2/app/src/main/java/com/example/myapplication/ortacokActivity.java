...
public class ortacokActivity extends AppCompatActivity {
    ...
    CountDownTimer countDownTimero = new CountDownTimer(60000, 1000) {
        @Override
        public void onTick(long l) {
            txt_sureyi_goster.setText("" + l / 1000);
            if (f == 8) {
                countDownTimero.cancel();
                AlertDialog.Builder builder = new AlertDialog.Builder(ortacokActivity.this);
                ...
                builder.setNegativeButton("Tamam", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Intent intent = new Intent(ortacokActivity.this, ortazorActivity.class);
        ...
        public void onFinish() {
            AlertDialog.Builder builder1 = new AlertDialog.Builder(ortacokActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ortacok);
